 ...
 *   VL53L5CX   0x29  multizone ToF (8x8 zone grid; center zone is altitude)
 *
...
/* Number of ToF zones (8x8 grid, row-major). */
#define TOF_GRID_ZONES 64

/* Reads one ToF frame. *altitude_mm gets the center-zone distance; grid[64]
